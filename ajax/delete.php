...
$query = "SELECT * FROM notes WHERE status='delete'";
$data = query($query);
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content modl">
                <div class="modal-body">
                    ...
                    <form action="setting/recovery.php" method="get">
                        <?php
                        $id = $d['id'];
                        ...
                        ?>
                            ...
                            <div class="mb-3">
                                <textarea id="text5" name="text5" rows="1" disabled cols="55" onkeypress="auto_grow(this)" onkeyup="auto_grow(this)" autocomplete="off"><?php echo $edit['title']; ?></textarea><br>
                                <textarea id="text6" name="text6" rows="1" disabled cols="55" onkeypress="auto_grow(this)" onkeyup="auto_grow(this)" autocomplete="off"><?php echo $edit['title']; ?></textarea><br>
                            </div>
